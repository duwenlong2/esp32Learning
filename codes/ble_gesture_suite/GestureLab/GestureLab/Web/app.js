...
const grid = new THREE.GridHelper(10, 10, 0x2e7c67, 0x1b3d36);
grid.position.y = -1.2;
scene.add(grid);
...
const cube = new THREE.Mesh(
  new THREE.BoxGeometry(0.16, 0.66, 1.08),
...
const edgeLines = new THREE.LineSegments(
  new THREE.EdgesGeometry(new THREE.BoxGeometry(0.16, 0.66, 1.08)),
...
function animate() {
  cubeGroup.rotation.x = THREE.MathUtils.lerp(cubeGroup.rotation.x, targetRotation.x, 0.14);
  cubeGroup.rotation.y = THREE.MathUtils.lerp(cubeGroup.rotation.y, targetRotation.y, 0.14);
  cubeGroup.rotation.z = THREE.MathUtils.lerp(cubeGroup.rotation.z, targetRotation.z, 0.14);

  cubeGroup.position.x = THREE.MathUtils.lerp(cubeGroup.position.x, targetPosition.x, 0.18);
  cubeGroup.position.y = THREE.MathUtils.lerp(cubeGroup.position.y, targetPosition.y, 0.18);
  cubeGroup.position.z = THREE.MathUtils.lerp(cubeGroup.position.z, targetPosition.z, 0.18);
